...
//             UniformBufferData CameraBuffer;
...
//         //     sizeof(UniformBufferData), props,
...
//         //     Buffer(sizeof(u32) * s_Data.MaxIndices, props,
...
//         // s_Data.CameraBuffer.X = camera.GetModel();
//         // s_Data.CameraBuffer.Y = camera.GetView();
//         // s_Data.CameraBuffer.Z = camera.GetProjection();
...
//                                            glm::vec3(0.0f, 0.0f, 1.0f));
//         auto swapChainExtent = s_Context->GetSwapchainExtent();
...
//         s_Context->UpdateUniformBuffer(ubo);
//         StartBatch();
//     }
...
//         //     s_Context->DrawIndexed(s_Data.Stats.GetTotalIndex(),
//         //                            s_Data.Stats.QuadCount, 0);
