...
//             quadIndices.clear();
//             s_Data.frameData.QuadVertexPositions[0] = {-1.0f, 1.0f,
//             0.0f, 1.0f}; s_Data.frameData.QuadVertexPositions[1] = {-1.0f,
//             -1.0f, 0.0f,
//                                                        1.0f};
//             s_Data.frameData.QuadVertexPositions[2] = {1.0f, -1.0f,
//             0.0f, 1.0f}; s_Data.frameData.QuadVertexPositions[3] =
//             {1.0f, 1.0f, 0.0f, 1.0f}; s_Data.resources.VertexBuffer =
//             CreateDynamicBuffer(
...
//                 s_Data.resources.set[i]; descriptorWrites[0].dstBinding = 0;
...
//         Flush();
//     }
//     void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2&
//     size,
...
//     }
//
//     void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2&
//     size,
//                               const glm::vec4& color)
//     {
//         glm::mat4 transform =
...
//             s_Data.frameData.QuadVertexBufferPtr->TexCoord =
//             textureCoords[i];
...
//             s_Data.frameData.QuadVertexBufferPtr->TexCoord =
//             textureCoords[i]; s_Data.frameData.QuadVertexBufferPtr->TexIndex
//             = textureIndex;
//             s_Data.frameData.QuadVertexBufferPtr->TilingFactor =
//             tilingFactor;
...
//
//         // bind index buffers
//         vkCmdBindIndexBuffer(cmd, *s_Data.resources.IndexBuffer->GetBuffer(),
//         0,
...
//             vkCmdDrawIndexed(cmd, s_Data.frameData.QuadIndexCount, 2, 0, 0,
//             0); s_Data.frameData.DrawCall++;
//         }
//     }
//     void Renderer2D::BindDescriptorSets(VkCommandBuffer cmd, Pipeline&
//     pipeline,
