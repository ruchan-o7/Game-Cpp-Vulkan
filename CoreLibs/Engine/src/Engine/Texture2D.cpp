...
namespace FooGame
{
    ...
    void CreateImage(Texture2D& image, VkExtent2D extent, VkFormat format, VkImageTiling tiling,
    ...
    void CreateImageView(Texture2D& image, VkFormat format, VkImageAspectFlags aspectFlags)
    {
        ...
        VK_CALL(vkCreateImageView(device, &viewInfo, nullptr, &image.ImageView));
    }
    ...
    void TransitionImageLayout(Texture2D* image, VkFormat format, VkImageLayout oldLayout,
